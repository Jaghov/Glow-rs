...
pub struct CelebABatcher;

impl<B: Backend> Batcher<B, CelebAItem, CelebABatch<B>> for CelebABatcher {
...
/// # Example
/// ```
/// use glow::dataset::celeba::CelebADataset;
/// use burn::data::dataset::Dataset;
///
